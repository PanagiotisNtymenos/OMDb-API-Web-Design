...
<script>
	function createBookmarks(movies) {
		...
		if (movies != '') {
			...
			document.getElementById("bookmarks_found").innerHTML = moviesList.length
					+ " Bookmarks found!";
			for (i = 0; i < moviesList.length; i++) {
				$.getJSON(
						'http://www.omdbapi.com/?apikey=274dad1c&t='
								+ encodeURI(moviesList[i])).then(
						function(result) {
...
<body onLoad="initialize();">
	...
	<header>
		<a href="index.jsp"><h1 class="item11" style="text-align: center;">
