...
<script>
						...
						$("#searchBar")
								.keyup(
										function(e) {
											...
											if (document
													.querySelector("#moreinf").style.display == "inline-block") {
												document
														.querySelector("#moreinf").style.display = "none";
	...
	function bookmark() {
		console.log(document.getElementById("save").textContent);
		if ((document.getElementById("bookmark_save").textContent == 'Save')) {
			document.getElementById("bookmark_save").innerHTML = "Saved";
			document.getElementById("bookmark_save").style.color = "#931f1f";
		} else {
			document.getElementById("bookmark_save").innerHTML = "Save";
					...
					.ajax({
						...
						success : function(response) {
							...
							if (response == "Guest") {
								document.getElementById("login_say").innerHTML = "Login";
								document.getElementById("register_say").innerHTML = "Register";
								alert('WRONG CREDENTIALS!!!\nOK! So...you pressed something VERY wrong and you maybe destroyed a whole country!\nNext time enter CORRECT credentials!\nTry again..');
							} else {
		...
		<div class="grid-flex">
			...
			<main>
				...
				<div id="menu" class="item22" style="overflow: hidden;">
					...
					<span id="loginas">Connected as, <span id="user_name"
						style="color: #931f1f">Guest</span>
					</span>
				</div>

				<div class="center">
					<div class="inner item33">
						<input id="searchBar" style="font-family: CaviarDreams;"
					...
					<div class="container">
						<div style="margin: auto;">
							<div id="preview" style="overflow: hidden;">
								<div>
									<img id="src" src="images/404.png" alt="Poster"
										class="responsive">
								</div>
								...
								<div>
									<a href="#"><img id="save"
										onClick="bookmark(); saveBookmark();">Save</a>
								</div>
				...
				<div class="login-popup">
					<div class="popup-content">
						<img src="icons/cancelred.png" onClick="logInPopUp('cancel')"
							width="20px" height="20px" alt="Cancel" class="cancel">
						...
						<form action="">
							...
							<a id="loginGO" href="#" class="button" onClick="callLogin()"
								style="font-size: 20px;">Login</a><br> <br>
						</form>
						<p style="font-size: 12px;">
							You don't have an account yet? <a href="#"
								onClick="signUpPopUp('signup'); logInPopUp('cancel');"
								style="font-size: 15px;"> Register!</a>
						</p>
						<br>
					</div>
				</div>
				...
				<div class="signup-popup">
					<div class="popup-content">
						<img src="icons/cancelred.png" onClick="signUpPopUp('cancel')"
							width="20px" height="20px" alt="Cancel" class="cancel">
						...
						<form action="">
							...
							<input id="second_password" type="password"
								placeholder="Confirm password"><br> <a href="#"
								onClick="callSignup();" style="font-size: 20px;">Register</a><br>
							<br>
						</form>
						<p style="font-size: 12px;">
							You already have an account? <a href="#"
								onClick="logInPopUp('login'); signUpPopUp('cancel');"
